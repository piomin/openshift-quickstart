    ...
    public void schedule() {
        try {
            ...
            try {
                ...
                event = new OrderEvent(delayed.getOrderCommand().getId(), "RESERVATION", "OK", "shipment-service");
            } catch (NotEnoughProductsException e) {
                LOG.error("Not enough products: id={}", delayed.getOrderCommand().getProductId());
                event = new OrderEvent(delayed.getOrderCommand().getId(), "RESERVATION", "FAILED", "shipment-service");
            }
